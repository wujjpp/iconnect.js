...
angular.module('iconnectApp')
  .factory("Layout", ['$window', 'Metronic', '$cookies', function ($window, Metronic, $cookies) {
    var Layout = function () {
      ...
      var handleSidebarToggler = function () {
        var body = $('body');
        if ($cookies.get('sidebar_closed') === '1' && Metronic.getViewPort().width >= resBreakpointMd) {
