...
angular.module('iconnectApp').factory('QuickSidebar', ['$window', 'Metronic', function($window, Metronic){
    ...
    var handleQuickSidebarChat = function () {
      ...
      var handleChatMessagePost = function (e) {
        ...
        var preparePost = function(dir, time, name, avatar, message) {
          ...
          tpl += '<img class="avatar" alt="" src="' + 'images/demo/' + avatar +'.jpg"/>';
  ...
  $window.QuickSidebar = QuickSidebar;
