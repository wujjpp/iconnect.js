...
module.exports = function () {
  ...
  return urlrouter(function (router) {
    ...
    router.get('/api/products/:productId', function (req, res) {
      res.end(JSON.stringify(filter(req.params.productId)));
    });
    ...
    router.post('/api/products', function (req, res) {
      ...
      _.extend(putData, {productId: guid.create()});
      products.push(putData);
    ...
    router.put('/api/products/:productId', function (req, res) {
      ...
      var instance = filter(req.params.productId);
    ...
    //delete task
    router.delete('/api/products/:productId', function (req, res) {
      products = _.filter(products, function (o) {
        return o.productId != req.params.productId;
      });
      res.end();
    });
  });
